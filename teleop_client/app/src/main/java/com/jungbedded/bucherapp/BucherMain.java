	...
	public void onClick(View clicked) {
		if(clicked == buttonConnect)
		{
			...
			try{
				...
				// SetOnClickListener on Button of Led and Buzzer when connected.
		...
		if(clicked == buttonClose)
		{
			...
			if(socket!=null)
			{
				...
				try{
					...
					// Disable OnClickListener on Button of Led and Buzzer when disconnected.
					buttonLed.setOnClickListener(null);
					buttonBuzzer.setOnClickListener(null);
